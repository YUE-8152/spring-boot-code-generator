...
import com.company.project.common.constant.GeneratorConstant;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        genCode("java","order_item");
        //genCode("xml","order_item");
    }

    public static void genCode(String type, String... tableNames) {
        if (type.equals("java")) {
            genCodeByJava(tableNames);
        } else {
            genCodeByXml(tableNames);
        }
    }
     ...
     */
    public static void genCodeByJava(String... tableNames) {
        for (String tableName : tableNames) {
            genCodeByCustomModelName(tableName, null);
        }
    }

    public static void genCodeByXml(String... tableNames) {
        for (String tableName : tableNames) {
            if (genModelAndMapperByXml()) {
    ...
    public static boolean genModelAndMapperByXml() {
        List<String> warnings = new ArrayList<String>();
        boolean overwrite = true;
        ConfigurationParser cp = new ConfigurationParser(warnings);
        try {
            Configuration config = cp.parseConfiguration(
                    KeyFactory.Generator.class.getResourceAsStream("/generator/config/generatorConfig.xml"));
            DefaultShellCallback callback = new DefaultShellCallback(overwrite);
        ...
        System.out.println("Xxx.java 生成成功");
        System.out.println("XxxMapper.java 生成成功");
        System.out.println("XxxMapper.xml 生成成功");
        return true;
    }
